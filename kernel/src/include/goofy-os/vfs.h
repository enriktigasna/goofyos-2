 ...
 * @ioctl: Ioctls file
 * @getdirents: Fill dentry children cache and increment their refcounts
 * @lookup: Lookup specific child of a vnode
 * @mkdir: Create directory under vnode
 * @create: Create file under vnode
...
struct vnode_operations {
	...
	int (*getdirents)(struct vnode *node, struct dentry *dentry);
